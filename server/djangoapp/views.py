...
def get_dealerships(request):
    context = {}
    if request.method == "GET":
        url = "https://us-east.functions.appdomain.cloud/api/v1/web/248065cb-83b1-445f-abcb-b28495febf7b/dealership-package/get-dealership"
...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://us-east.functions.appdomain.cloud/api/v1/web/248065cb-83b1-445f-abcb-b28495febf7b/dealership-package/get-dealership"
